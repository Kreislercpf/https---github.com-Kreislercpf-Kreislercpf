                ...
                <div class="row">
                    ...
                    <div class="row">
                        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                            <thead>
                                <tr>
                                    <th>First Name</th><th>Last Name</th><th>Email Address</th><th>Date of Birth</th><th>Gender</th><th>ContactNo</th><th>Address</th> <!--Column/Fields-->
                                </tr>
                            </thead>
                            <tbody>
    ...
    ?>
                                ...
                                <?php
                                    ...
                                    while ($rows=mysqli_fetch_array($retrieve)) {
                                        $image_query = "SELECT * FROM users_db WHERE id='$id' "; //query user image 
