                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            require_once('connect.php');
                                ...
                                $query = "UPDATE users_tbl SET firstname = '$fname', lastname = '$lname',email = '$email', birthdate = '$bdate', gender = '$gender', address = '$address', regs_date = '$regs_date' where id='$user_id'";
